...
(function(w) {
    var n = window,
        ...
        e = {
            ...
            classList: {
                contains: function(a, b) {
                    if (a) return a.classList ? a.classList.contains(b) : !!a.className &&
        ...
        y = function(a, b, c) {
            if ("[object Object]" === Object.prototype.toString.call(a))
                for (var d in a) Object.prototype.hasOwnProperty.call(a, d) &&
                    b.call(c, d, a[d]);
            else {
                d = 0;
        ...
        A;
    (A = n.cancelAnimationFrame) || (clearTimeout(void 0),
        A = void 0);
    var F = A;
    A = function(a, b) {
    ...
    r.init = function() {
        var a = this,
            ...
            c = a.events;
        if (!a.initialised) {
            if (a.textarea) a.content = a.container, a.container = p.createElement("div"),
                e.classList.add(a.container, b.classes.textarea), a.wrapper = p.createElement("div"), e.classList.add(a.wrapper, b.classes.wrapper), a.container.appendChild(a.wrapper), a.content.parentNode.insertBefore(a.container, a.content), a.content.addEventListener("input", function(h) {
                    a.update()
                });
            else
                for (a.content = p.createElement("div"); a.container.firstChild;) a.content.appendChild(a.container.firstChild);
            e.classList.add(a.container, b.classes.container);
            e.classList.add(a.content, b.classes.content);
            b.alwaysShowBars &&
                e.classList.add(a.container, b.classes.visible);
            ...
            "MutationObserver" in window && (g = function(h, l) {
                if (a.intersectionObserver)
                    for (var k = $jscomp.makeIterator(h), m = k.next(); !m.done; m = k.next())
                        if (m = m.value, "childList" == m.type) {
    ...
    r.scrollTo = function(a, b) {
        ...
        var c = this.getData(),
            d;
        "string" === typeof a ? "start" === a ? d = -c[u[b]] : "end" === a && (d = c[z[b]] -
            c[K[b]] - c[u[b]]) : d = a - c[u[b]];
        this.scrollBy(d, b)
    };
    r.scrollBy = function(a, b, c, d) {
        void 0 === b && (b = "y");
        if (0 === c) this.content[u[b]] += a;
        else {
            void 0 === c && (c = 250);
    ...
    r.update = function() {
        ...
        e.classList.toggle(a.container,
            "mb-scroll-y", g && b.scrollY && !b.hideBars);
        e.css(c, {
            overflowX: f ? "auto" : "",
            overflowY: g ? "auto" : "",
            marginBottom: f ? -d : "",
        ...
        a.updateBars();
        a.wrapperPadding = 0;
        a.textarea && (b = e.css(a.wrapper), a.wrapperPadding = parseInt(b.paddingTop, 10) + parseInt(b.paddingBottom, 10), !a.down && a.content.selectionStart >= a.content.value.length && (a.content.scrollTop =
            a.scrollToBottom()));
    ...
    r._mouseup = function(a) {
        var b = this.config,
            c = this.events;
        e.classList.toggle(this.container,
            b.classes.visible, b.alwaysShowBars);
