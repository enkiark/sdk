...
! function(a, b, c) {
    ...
    a.fn.stickyNavbar = function(d) {
        ...
        return f.attr("tabindex", -1), this.each(function() {
            var d = a(this),
                g = d.css("position"),
                h = d.css("zIndex"),
                i = d.outerHeight(!0),
            ...
            l.click(function(b) {
                var g, h, j, k, l;
                if (g = "li" === e.selector ? a(this).children("a").attr("href") : a(this).attr("href"), "http" === g.substring(0, 4) || "https" === g.substring(0, 5) || "mailto:" === g.substring(0, 7) || "/" === g.substring(0, 1) || "../" === g.substring(0, 3)) return !0;
                for (b.preventDefault(), h = g.substr(1), l = f.length, k = {}, j = 0; l > j; j++) k[f[j].id] = f[j].offsetTop;
                var m = d.hasClass(e.unstickyModeClass) ? k[h] - 2 * i + 2 + "px" : k[h] - i + 2 + "px";
            ...
            var o = function() {
                ...
                if (l.removeClass(e.activeClass), f.each(function() {
                    ...
                    }), n >= j + e.startAt ? (d.removeClass(e.unstickyModeClass).addClass(" " + e.stickyModeClass), d.css({
                        position: "fixed",
                        zIndex: e.zindex
                    }).stop(), e.jqueryEffects ? (e.animateCSSRepeat || d.hide().stop()[e.jqueryAnim](e.animDuration, e.easing), d.hide().stop()[e.jqueryAnim](e.animDuration, e.easing)) : e.animateCSS ? e.animateCSSRepeat ? d.addClass(e.cssAnimation + " animated").one("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd", function(a) {
                        d.removeClass(e.cssAnimation + " animated")
                    }) : d.addClass(e.cssAnimation + " animated").one("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd") : d.stop()) : d.css({
                        position: g,
                        zIndex: h
                    }).removeClass(e.stickyModeClass).addClass(" " + e.unstickyModeClass), "undefined" != typeof q) {
                    var q = f.last(),
                        r = q.offset().top + q.outerHeight(!0);
                    m.scrollTop() + p >= a(c).height() && r >= n && l.removeClass(e.activeClass).last().addClass(e.activeClass), j - 2 >= n && (d.removeClass(e.cssAnimation + " animated"), e.jqueryEffects ? (0 === n && l.removeClass(e.activeClass), n >= j ? d.css({
                        position: "fixed",
                        zIndex: e.zindex
                    }).hide().stop()[e.jqueryAnim](e.animDuration, e.easing) : d.css({
                        position: g,
                        zIndex: e.zindex
                    })) : (0 === n && l.removeClass(e.activeClass), d.css({
                        position: g,
                        top: k
                    }).stop().animate({
                        top: k
